...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager, JwtUtils jwtUtils) {
        ...
        filterChainDefinitionMap.put("/dc/dcScheme/**","anon");
        filterChainDefinitionMap.put("/sys/user/**","anon");
        filterChainDefinitionMap.put("/master/test/**","anon");
        ...
        filterChainDefinitionMap.put("/micro/microApp/**", "anon");
        filterChainDefinitionMap.put("/micro/microVersion/**", "anon");

        filterChainDefinitionMap.put("/databus/dataBusBaseInterface/**", "anon");
