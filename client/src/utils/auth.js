...
const TokenKey =  'dev_token'
const CurrentUserKey = 'dev_currentUser'
const RoutersKey = 'dev_routers'
const SysSettingKey = 'dev_sysSetting'
const DataPermisionsKey = 'dev_dataPermisions'
const PersonalThemeKey = 'dev_personalTheme'
